<template>
    <div class="container mx-auto mt-10 mb-32 px-5">
        <div class="w-full h-56 flex justify-center items-center bg-slate-400 rounded-xl mb-10 bg-[url('../src/assets/about-bg.jpg')] bg-center bg-cover">
            <h1 class="text-center font-bold text-5xl text-slate-50">About</h1>
        </div>
        <p class="mb-5 text-xl font-medium leading-relaxed">
